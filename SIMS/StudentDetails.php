...
<div class="container">
	...
	<div class="row">
		<div class="col-md-12">
			<h3 class="page-header"><b>Welcome <a href="welcomeadmin">Admin</b></a> </h3>
			<?php
			include( "database.php" );
			$sql = "select * from  studenttable";
			$result = mysqli_query( $connect, $sql );
			echo "<h2 class='page-header'><b>Student Details</b></h2>";
...
<th>Delete</th>		
			...
			<tr>
				...
				<td><a href="DeleteStudent.php?eno=<?php echo $row['Eno']; ?>"><input type="submit" Value="Delete" name="delete" class="btn btn-info btn-sm"></a>
				</td>
			</tr>
			<?php } ?>
			</table>
