...
<div class="container">
	<div class="row">
		<div class="col-md-4">
			...
			<h4 class="page-header">Add New Teacher </h4>
			<?php
			...
			<form action="" method="POST" name="update">
				...
				<div class="form-group">
					<label for="Faculty Name">Teacher Name : <span style="color: #ff0000;">*</span></label>
				...
				<div class="form-group">
					...
					<input type="text" name="course" class="form-control" id="fname" required>
				</div>
				...
				<div class="form-group">
					<input type="submit" value="Add New Teacher" name="addnewfaculty" class="btn btn-primary">
</div >
			...
			if ( isset( $_POST[ 'addnewfaculty' ] ) ) {
				...
				// adding new faculty
				$sql = "insert facutlytable (FName, FaName, Addrs, Gender, JDate, City, Pass, PhNo,course) values ('$tempfname', '$tempfaname', '$tempaddrs','$tempgender', '$tempjdate', '$tempcity' , '$temppass','$tempphno','$tempcourse')";
