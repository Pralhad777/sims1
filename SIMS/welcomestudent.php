...
<div class="container">
	<div class="row">
		<div class="col-md-8">
			...
			<h3><b> Welcome <?php echo "<span style='color:red'>".$userfname." ".$userlname."</span>";?></b></h3>
			...
			<a href="advice.php?seno=<?php echo $sEno;  ?>"> <button  href="" type="submit" class="btn btn-primary" >view advise</button></a>
			<a href="yourteacher.php?seno=<?php echo $sEno;  ?>"><button  href="" type="submit" class="btn btn-primary">Your Teacher</button></a>
