...
<div class="container">
	...
	<div class="row">
		<div class="col-md-8">
			...
			echo "<h3 class='page-header' ><b>Teacher Details</b></h3>";
			...
			<a href="addnewfaculty"><button type="button" value="Add New FacultyTe" class="btn btn-info btn-sm">Add New Teacher</button></a>
