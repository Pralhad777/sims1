	...
	<div class="row">
		<div class="col-md-12">
			...
			<form action="" method="POST" name="update">
				...
				<div class="form-group">
					D.O.B. : <br><br><input type="text" name="DOB" value="<?PHP echo $row['DOB'];?>" placeholder="YYYY-MM-DD"><br>
				</div>
				<div class="form-group">
					Addres : <br><br><input type="text" name="addrs" value="<?PHP echo $row['Addrs'];?>"><br>
				</div>
				<div class="form-group">
					Gender : <br><br><input type="text" name="g" value="<?PHP echo $row['Gender'];?>"><br>
				</div>
				<div class="form-group">
					Phone Number :<br><br> <input type="tel" name="phno" value="<?PHP echo $row['PhNo'];?>" maxlength="10"><br>
				</div>
				<div class="form-group">
					Email : <br><br><input type="text" name="email" value="<?PHP echo $row['Eid'];?>" readonly><br>
				</div>
				<div class="form-group">
